...
import { BrowserProvider, encodeBytes32String, formatUnits, parseUnits } from "ethers";
...
interface RoundInfo {
  ...
  matchingBudget: string;
  active: boolean;
}

const MatchingPool: React.FC<Props> = ({ provider }) => {
        ...
        <div className="grid lg:grid-cols-2 gap-8">
          <div className="card">
            ...
            <div className="space-y-6">
              ...
              <button onClick={handleDonate} disabled={loading} className="btn btn-primary btn-lg w-full">
        ...
        {isOwner && (
          <div className="space-y-8">
            ...
            <div className="card">
              ...
              <button onClick={handleCreateRound} disabled={loading} className="btn btn-primary btn-lg w-full mt-6">
            ...
            <div className="card">
              ...
              <div className="flex gap-4">
                <button onClick={handleActivateRound} disabled={loading} className="btn btn-success flex-1">
                  {loading ? "Processing..." : "▶️ Activate Round"}
                </button>
                <button onClick={handleDeactivateRound} disabled={loading} className="btn btn-secondary flex-1">
            ...
            <div className="card">
              ...
              <button onClick={handleAddProject} disabled={loading} className="btn btn-primary w-full mt-6">
            ...
            <div className="card">
              ...
              <div className="space-y-6">
                ...
                <button onClick={handleFinalize} disabled={loading} className="btn btn-primary btn-lg w-full">
