            ...
            {[
              ...
              <button
                ...
                className={`px-4 py-2 text-sm font-medium rounded-md transition-colors ${
                  timeframe === key ? "bg-white text-gray-900 shadow-sm" : "text-gray-600 hover:text-gray-900"
                }`}
              >
                {label}
              </button>
        ...
        <div className="card">
          <div className="card-header">
            ...
            <p className="card-description">
              {timeframe === "all" ? "All-time" : timeframe === "month" ? "Monthly" : "Weekly"} verified
          ...
          {loading ? (
            ...
            <div className="space-y-3">
              {rows.map((r, index) => (
                <div
                  key={r.user}
                  className="flex-between p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors animate-fade-in"
                >
                  <div className="flex items-center gap-4">
